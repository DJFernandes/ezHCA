...
I uploaded some example HDF5 files (https://wiki.mouseimaging.ca/display/MICePub/Home+Cage+Analysis). I downloaded them and put them all in a directory ('hcadata/'). You can use any files HDF5 files from the Actual Analytics home cage monitoring system.
...
```{r}
# change name from hcaGetHDF5series to hcaReadHDF5series
# give option for aggretime
subjectdatalist = hcaGetHDF5series( hdf5files , subjectIDs = c("900026000623623", "900026000623624", "900026000623653","900026000623654") )
```
